...
export function Hero() {
    ...
    return (
        <section className="relative min-h-[70vh] md:min-h-[85vh] w-full flex items-start md:items-center justify-center overflow-hidden pt-28 pb-12 md:pt-24 md:pb-20">
