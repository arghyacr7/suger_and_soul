...
export function Hero() {
    ...
    return (
        <section className="relative min-h-[50vh] md:min-h-[85vh] w-full flex items-start md:items-center justify-center overflow-hidden pt-16 pb-4 md:pt-20 md:pb-20">
